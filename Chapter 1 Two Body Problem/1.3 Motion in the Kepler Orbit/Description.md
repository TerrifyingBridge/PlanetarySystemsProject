...
Overall, there is a bunch of stuff to fix in this program that I wasn't able to fully implement. If I were to work on this project more, I would have ironed it out, but I need to move on to the next project. Similarly, there are a bunch of non-bug fixes I wanted to implement, such as a cleaner GUI or adding important information to the user such as telling them the eccentricity of the orbit before plotting it. Regardless of this, I am really happy with how it turned out, and the ellptical orbits look pretty and really cool, especially being able to start at any point in the orbit instead of just the periapsis or apoapsis like the previos project.
